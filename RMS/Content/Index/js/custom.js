...
(function($) {
    "use strict";
		...
		$('.switcher').click(function(){
			...
			jQuery('#changeable-colors').attr('href', '~/Content/Index/css/colors/' + title + '.css');				
			return false;
		});	
		
		jQuery(".orange-bg").on('click',function(){
            jQuery(".logo-header img").attr("src", "~/Content/Index/images/logo.png");
            jQuery(".footer-logo .text-center img").attr("src", "~/Content/Index/images/logo.png");
			return false;
		});
